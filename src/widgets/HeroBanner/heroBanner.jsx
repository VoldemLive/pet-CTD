...
const HeroBanner = () => {
  const imagesList = [
    "https://www.artic.edu/iiif/2/b3974542-b9b4-7568-fc4b-966738f61d78/full/400,/0/default.jpg",
    "https://www.artic.edu/iiif/2/ca291a36-df9c-0926-49d8-d700b402f5bf/full/400,/0/default.jpg",
    "https://www.artic.edu/iiif/2/43bc66e2-95b2-fb3c-b9b1-232835bfd027/full/400,/0/default.jpg",
    "https://www.artic.edu/iiif/2/b272df73-a965-ac37-4172-be4e99483637/full/400,/0/default.jpg",
    "https://www.artic.edu/iiif/2/ddacae05-9279-51b5-e9ab-00024ae01e27/full/400,/0/default.jpg",
    "https://www.artic.edu/iiif/2/92777387-4f55-e3fa-10ba-a549810aca95/full/400,/0/default.jpg",
    "https://www.artic.edu/iiif/2/de8b304b-8250-78cf-dfa2-5f91458b78f9/full/400,/0/default.jpg",
    "https://www.artic.edu/iiif/2/12d51cb8-7299-9a5c-12d0-437be56e6669/full/400,/0/default.jpg",
    "https://www.artic.edu/iiif/2/4e634f28-2893-9d95-ab56-cd45c33b682f/full/400,/0/default.jpg",
    "https://www.artic.edu/iiif/2/4d152c81-8389-e426-e5f2-e98902d2515a/full/400,/0/default.jpg",
    "https://www.artic.edu/iiif/2/baba4a4e-ca86-7e95-915d-25c352fc3571/full/400,/0/default.jpg",
    "https://www.artic.edu/iiif/2/94e5a256-6e62-d862-85d8-d940113f5621/full/400,/0/default.jpg",
  ]

  const fillImages = (count) => {
    const filledImages = []
  ...
  const ImageStrip = ({ direction = "up", duration = "30s", style }) => {
    const images = fillImages(10)
    const doubledImages = [...images, ...images]

    return (
      <div
        className={`image-strip ${direction}`}
        style={{
      ...
      >
        {doubledImages.map((imageSrc, index) => (
          <img key={index} src={imageSrc} alt="" className="strip-image" />
        ))}
      </div>
    )
  }
  ...
  return (
    <div className="hero-banner">
      <div className="rotated-container saturate-150">
        <ImageStrip
          className="shadow-xl"
          direction="down"
          duration="45s"
      ...
      <div className="banner-content text-gray-100 w-full h-full items-center justify-center content-center bg-black/60">
        <div className="flex text-center flex-col gap-10 justify-center content-center items-center">
          <svg width="112" height="112" viewBox="0 0 956 957">
            <path
              fill="currentcolor"
          ...
          <h1 className="text-2xl font-semibold lg:text-2xl">
            Arthive: Your Gateway to Art's Treasures.
          </h1>
          <p className="max-w-[80%] lg:max-w-[60%] text-2xl lg:text-4xl">
            Dive into the Art Institute of Chicago's collection. Simple. Direct.
            Inspiring. Start your journey of discovery now.
          </p>
          <Link
            className="bg-purple-800 rounded-sm hover:bg-purple-900 px-6 py-2.5 text-white translate-all duration-300"
            to="/artworks"
          >
            Explore now
          </Link>
