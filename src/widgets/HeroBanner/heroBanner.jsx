...
const HeroBanner = () => {
  ...
  return (
    <div className="hero-banner">
      ...
      <div className="banner-content text-slate-100 w-full h-full items-center justify-center content-center bg-black/60">
        <div className="flex flex-col gap-4 justify-center content-center items-center">
          <svg width="128" height="128" viewBox="0 0 956 957">
            <path
              fill="currentcolor"
          ...
          <h1>We are ARTHIVE</h1>
          <p className="max-w-[450px]">
            Easy access to a vast collection of art from the Art Institute of
            Chicago.
          </p>
        </div>
      </div>
